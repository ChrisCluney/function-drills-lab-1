...
//     return (num1 > num2) ? console.log(num1) : (num1 === num2) ? console.log(num1) : console.log(num2)
...
// console.log(exclaimThree("Chris"));
...
function faveColorFinder(color) {
  return color === `red`
    ...
    : color === `black`
    ? "so trendy"
    : `you need to evalute your favorite color choice`;
}
...
console.log(bestMovie(`Black Panther`));
...
const newContestantArray = theEliminator(contestants, loser);
...
//     }
// }
// console.log(emailCheck("ccluney@gmail.com"));

////////////////// PROBLEM 19 ////////////////////
/*
    Write a function, naming it whatever you believe to be appropriate, that buys as many chocolate frogs as possible with a certain amount of gold. Each chocolate frog 
    costs 3 gold. Your function should take in a single parameter, which is the amount of gold you are willing to spend. Your function should return a total amount of 
...
////////////////// PROBLEM 20 ////////////////////
/*
    You might have noticed a slight bug in the previous problem. If you were to pass in 4 gold, the function would return to you 1.3333... However, you can't 
    really go to a store and by 1.333 products. You would just be able to purchase 1 product. Re-write the function you used in the previous problem (give it the same 
        name, just add a 2 to the end of it) that fixes this bug. Invoke the function and store the returned value to a variable called `totalFrogs2`.
  */
...
const totalFrogs2 = buyingChocolatefrogs2(12);
